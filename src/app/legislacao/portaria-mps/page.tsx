...
export default function Home() {
  ...
  const fetchData = async () => {
    try {
      const response = await AxiosInstance.get("/pages/663");
          ...
          <div className="pl-5 pt-2 font-light">
            ...
            <p>
              <LinkAzul
                ...
                text="Lei n°10887/04 – "
              />
              Dispõe sobre a aplicação de disposições da Emenda Constitucional
              no 41/03, altera dispositivos das Leis nos 9.717/98, 8.213/91,
              9.532/97
            </p>
            <p>
              <LinkAzul
