    ...
    <article className="w-full flex justify-center bg-white pb-2">
      <section className="px-2 container">
        ...
        <div className="w-full grid lg:grid-cols-2 items-center container gap-5">
          {/* Formulário */}
          <div><h2>Formulário</h2></div>
          <div>
            <p className="text-sm md:text-xl font-bold">Telefone Geral:</p> <br />
            <p className="text-sm">(62)3545-5934 </p> <br />
            <p className="text-sm md:text-xl font-bold">Celular ouvidoria:</p> <br />
            <p className="text-sm">(62) 99629-2211 (WhatsApp)</p> <br />
            <p className="text-sm md:text-xl font-bold">Telefone Fixo Ouvidoria::</p> <br />
