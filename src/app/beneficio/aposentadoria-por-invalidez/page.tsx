...
export default function Home() {
  return (
    <Container title="Aposentadoria por invalidez" className="space-y-4">
      ...
      <p>
        <span className="font-bold">§1º – </span>A aposentadoria por invalidez
        será precedida de auxílio-doença.
      </p>
      <p>
        <span className="font-bold">§2º – </span>A aposentadoria por invalidez
        terá proventos proporcionais ao tempo de contribuição, calculados
        conforme o disposto no art. 25 da presente Lei, exceto se decorrente de
        acidente em serviço, moléstia profissional ou doença grave, contagiosa
        ou incurável, sendo estas definidas no §6º, deste artigo, que será
        calculado de acordo com o disposto no art. 24 da presente Lei.
      </p>
      <p>
        ...
        atribuições deste, provocando lesão corporal ou perturbação funcional
        que cause a perda permanente ou temporária da capacidade para o
        trabalho.
      </p>
      <p>
      ...
      <p>
        <span className="font-bold">I – </span>o acidente ligado ao serviço que,
      ...
      <div>
        <span className="font-bold">IV – </span>o acidente sofrido pelo segurado
      ...
      <p>
        <span className="font-bold">§6º – </span>onsideram-se doenças graves,
        contagiosas ou incuráveis, a que se refere o §2º, deste artigo,
      ...
      <p>
        <span className="font-bold">§7º – </span>A concessão de aposentadoria
        por invalidez dependerá da verificação da condição de incapacidade,
        mediante exame médico-pericial do órgão competente.
      </p>
      <p>
        <span className="font-bold">§8º – </span>Em caso de doença que impuser
        afastamento compulsório, com base em laudo conclusivo da medicina
        especializada, ratificado pela Perícia Médica do RPPS, a aposentadoria
        por invalidez independerá de auxílio-doença e será devida a partir da
      ...
      <p>
        ...
        submeter anualmente ao exame da Perícia do RPPS, sob pena de suspensão
        do pagamento do seu benefício, caso seja verificada a cessação da
        incapacidade o benefício será extinto ex-oficio.
      </p>
    </Container>
  );
}
