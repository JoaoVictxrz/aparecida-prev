      ...
      <section className="px-2 container">
        ...
        <div className="w-full container gap-5 pb-20 space-y-4">
          ...
          <p>
            ...
            consistirá numa importância mensal conferida ao conjunto dos
            dependentes do segurado, quando do seu falecimento.
          </p>

          <p>
            <span className="font-bold">1º</span> – Será concedida pensão
          ...
          <p>
            ...
            transformada em definitiva com o óbito do segurado ausente ou deve
            ser cancelada com reaparecimento do mesmo, ficando os dependentes
          ...
          <p>
            <span className="font-bold">II</span> – da data da decisão judicial,
          ...
          <p>
            <span className="font-bold">Art.50 –</span> O valor da pensão por
            morte será igual:
          </p>
          ...
          <p>
            <span className="font-bold">II</span> – à totalidade da remuneração
            de contribuição percebida pelo servidor no cargo efetivo na data
            anterior à do óbito, até o limite máximo estabelecido para os
            benefícios do regime geral de previdência social, acrescido de
            setenta por cento da parcela excedente a este limite.
          </p>

          <p>
            <span className="font-bold">Art.51 –</span> A pensão será rateada
            entre todos os dependentes em partes iguais e não será protelada
            pela falta de habilitação de outro possível dependente.
          </p>

          <p>
            <span className="font-bold">1º</span> – O cônjuge ausente não exclui
            do direito à pensão por morte o companheiro ou a companheira.
          </p>

          <p>
            <span className="font-bold">2º</span> – A habilitação posterior que
            importe inclusão ou exclusão de dependente só produzirá efeitos a
            contar da data da inscrição ou habilitação.
          </p>

          <p>
            <span className="font-bold">3º</span> – Serão revertidos em favor
            dos dependentes e rateados entre eles a parte do benefício daqueles
            cujo direito à pensão se extinguir.
          </p>

          <p>
            <span className="font-bold">4º</span> – O pensionista de que trata o
            §1º do art. 48 deverá anualmente declarar que o segurado permanece
            desaparecido, ficando obrigado a comunicar imediatamente ao órgão
            gestor do Regime Próprio de Previdência Social de Aparecida de
            Goiânia o reaparecimento deste, sob pena de ser responsabilizado
          ...
          <p>
            ...
            emancipação for decorrente de colação de grau científico em curso de
            ensino superior.
          </p>
          ...
          <p>
            <span className="font-bold">Parágrafo único</span> – Com a extinção
          ...
          <p>
            ...
            dependente condenado pela prática de crime doloso de que tenha
            resultado a morte do segurado.
          </p>

          <p>
            <span className="font-bold">Art.55 –</span> Será admitido o
            recebimento, pelo dependente, de até duas pensões no âmbito do
            Regime Próprio de Previdência Social de Aparecida de Goiânia, exceto
            a pensão deixada por cônjuge, companheiro ou companheira que só será
            permitida a percepção de uma, ressalvado o direito de opção pela
            mais vantajosa.
          </p>

          <p>
            <span className="font-bold">Art.56 –</span> A condição legal de
            dependente, para fins desta lei, é aquela verificada na data do
            óbito do segurado, observados os critérios de comprovação de
            dependência.
          </p>

          <p>
            <span className="font-bold">Parágrafo único</span> – A invalidez ou
            a alteração de condições quanto ao dependente, supervenientes à
